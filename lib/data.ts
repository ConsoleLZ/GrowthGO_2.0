...
export const sites: Site[] = [
  ...
  },
  {
    ...
    description: "Claude Code 能读取你的代码库、编辑文件、运行命令，并跨多个文件和工具协同工作来完成任务。你可以把它想象成一个住在你终端里的资深程序员搭档",
    tags: [tags.ai],
    recommend: true
  },
  {
    name: "Open Design",
    ico: "https://open-design.ai/favicon.ico",
    url: "https://open-design.ai/zh/",
    description: "Open Design 是开源、本地的 vibe design workspace——把你已经在用的 coding agent 变成设计引擎，从想法到原型、网页、Slides、HTML 视频，全流程在你自己的设备上完成。Agent-native，接入 21 个 Coding Agent、151 个 Design System，Apache-2.0。",
    tags: [tags.ai],
    recommend: true
  },
  {

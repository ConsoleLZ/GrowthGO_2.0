...
export const sites: Site[] = [
  ...
  },
  {
    ...
    description:
      "这是一款开源的自我进化型 AI Agent，能够与用户共同成长的个人 AI 助手。它内置学习循环机制，可根据过往任务经历自动创建和优化技能（Skills），支持跨会话持久化记忆、自由切换模型和接入多种消息平台。",
    tags: [tags.ai],
  },
  {
    name: "Dify",
    ...
    url: "https://dify.ai/",
    description:
      "在统一协作画布上构建 Agentic 工作流、RAG Pipeline，有丰富模型和工具集成，支持创建自己的知识库",
    tags: [tags.ai],
    recommend: true,
  },
  {
  ...
  },
  {
    ...
    description:
      "Open Design 是开源、本地的 vibe design workspace——把你已经在用的 coding agent 变成设计引擎，从想法到原型、网页、Slides、HTML 视频，全流程在你自己的设备上完成。Agent-native，接入 21 个 Coding Agent、151 个 Design System，Apache-2.0。",
    tags: [tags.ai],
    recommend: true,
  },
  {
    ...
    description:
      "TRAE Work 是一款 AI 原生工作台，提供网页版、桌面版和移动版三种形态，并设有为不同用户群体设计的 Work 与 Code 双模式。TRAE Work 的能力在原有 TRAE IDE SOLO 模式的基础上得到了进一步提升，旨在为用户提供统一、高效、可定制的 AI 协作体验，覆盖从专业开发到日常办公的各类场景。",
    tags: [tags.ai],
    recommend: true,
  },
  {
  ...
  },
  {
    ...
    description:
      "古文岛作为传承经典的网站专注于古诗服务，致力于让古诗爱好者更便捷地发表及获取古诗相关资料。",
    tags: [tags.learning],
  },
  {
    name: "ChatUI",
  ...
  {
    name: "PromptPilot",
    ico: "https://lf3-static.bytdnsdoc.com/obj/eden-cn/lm_sth/ljhwZthlaukjlkulzlp/autope/logo/prompt-pilot.png",

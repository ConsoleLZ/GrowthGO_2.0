...
const contactLinks = [
  { label: "Email", value: "17347187569@163.com", href: "mailto:17347187569@163.com" },
  { label: "GitHub", value: "@ConsoleLZ", href: "https://github.com/ConsoleLZ" },
  { label: "博客", value: "consolelz.github.io", href: "https://consolelz.github.io/" },
  { label: "掘金", value: "小哲的技术分享", href: "https://juejin.cn/user/1295692732053241" },
]
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed max-w-md">
              无论你有技术问题、合作想法，或者只是想打个招呼，我都很乐意收到你的消息。
            </p>
            <a
